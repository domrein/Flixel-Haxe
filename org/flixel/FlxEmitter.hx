package org.flixel;
	...
	class FlxEmitter extends FlxGroup {
		 ...
		 */
		public function setXSpeed(?Min:Int=0,?Max:Int=0):Void
		{
		 ...
		 * @param	Max		The maximum value for this range.
		 */
		public function setYSpeed(?Min:Int=0,?Max:Int=0):Void
		{
		 ...
		 * @param	Max		The maximum value for this range.
		 */
		public function setRotation(?Min:Int=0,?Max:Int=0):Void
		{
			minRotation = Min;
			maxRotation = Max;
		}
		 ...
		 */
		public function start(?Explode:Bool=true,?Delay:Int=0,?Quantity:Int=0):Void
		{
			if(members.length <= 0)
			{
		 ...
		 */
		public function stop(?Delay:Int=3):Void
		{
			_explode = true;
			delay = Delay;
			if(delay < 0)
